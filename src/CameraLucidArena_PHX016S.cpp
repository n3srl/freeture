    ...
    */
    ...
    bool CameraLucidArena_PHX016S::initOnce()
    {
        ...
        ArenaSDKManager::setBooleanValue(m_ArenaDevice, "GammaEnable", false);
         ...
         LOG_DEBUG << "CameraLucidArena_PHX016S::initOnce;" << "DeviceStreamChannelPacketSize = 9000";
         ArenaSDKManager::setIntegerValue(m_ArenaDevice, "DeviceStreamChannelPacketSize", 9000);
